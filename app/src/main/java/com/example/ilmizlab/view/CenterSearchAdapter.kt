...
interface CenterSearchCallback{
    fun onClickItem(item: TrainingCenterModel)
}

class CenterSearchAdapter(val items: List<TrainingCenterModel>, val callback: CenterSearchCallback): RecyclerView.Adapter<CenterSearchAdapter.ItemHolder>() {
